...
master_doc = 'index'
latex_documents = [
    ('index_latex', 'EPANETMSX.tex', 'EPANET USERS MANUAL',
     author, 'manual'),]
...
exclude_patterns = ['toolkit.rst', 'binary.rst', 'errorcodes.rst']
...
latex_elements = {
   ...
   'maketitle': r'''       
        ...
        \begin{titlepage}
            ...
            \vspace*{30mm}
            \centering
            \textbf{\Huge {EPANET-MSX 2.0 User Manual}}
...
latex_documents = [
    ('index_latex', 'EPANETMSX.tex', 'EPANETMSX USERS MANUAL',
     author, 'manual'),
]

bibtex_reference_style = 'author_year'

#latex_appendices = ['reference', 'toolkit', 'binary', 'errorcodes']
...
man_pages = [
    (master_doc, 'EPANETMSX', 'EPANETMSX USERS MANUAL',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EPANETMSX', 'EPANETMSX USERS MANUAL',
     author, 'EPANETMSX', 'One line description of project.',
     'Miscellaneous'),
]
